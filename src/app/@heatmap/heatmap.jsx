...
export default function SubmissionHeatmap() {
  ...
  // Simulated values (use real backend data here)
  const values = useMemo(() => {
    ...
    while (date <= end) {
      const random = Math.floor(Math.random() * 6); // 0 to 5 submissions
  ...
  return (
    <div className="bg-white rounded-lg shadow p-4 w-full h-46">
